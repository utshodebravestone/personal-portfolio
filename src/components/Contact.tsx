...
const Contact = () => {
  const onSubmit = ({
    ...
    window.open(
      `mailto:utshodebravestone@gmail.com?cc=${email}&subject=Message from ${name.toUpperCase()} (via Utsho's Personal Website)&body=${message}`
    );
  };
  ...
  return (
    <section className="bg-neutral-900 w-full py-5 px-2.5 md:px-10 flex flex-col gap-2.5 md:gap-5 rounded-xl border border-neutral-700">
      ...
      <iframe
        ...
        loading="lazy"
        className="w-full h-80 md:h-96 grayscale-100 invert rounded-md"
      ></iframe>
      ...
      >
        ...
        <div className="w-full flex flex-col md:flex-row justify-center gap-5">
          <input
            ...
            className="p-2 w-full md:w-1/2 h-12 font-normal bg-neutral-900 border border-neutral-700 rounded-md text-gray-100 outline-none [&:not(:placeholder-shown)]:invalid:border-red-500 valid:border-green-500"
            autoComplete="false"
        ...
        <textarea
          ...
          minLength={16}
          placeholder="Message"
          className="w-full p-2 font-normal bg-neutral-900 border border-neutral-700 rounded-md text-gray-100 outline-none [&:not(:placeholder-shown)]:invalid:border-red-500 valid:border-green-500"
          onChange={handleInputChange}
