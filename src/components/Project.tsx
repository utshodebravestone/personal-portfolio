...
const Project = ({
  ...
  return (
    <div className="relative w-full mx-2.5 md:mx-0 px-2.5 py-2.5 flex flex-col gap-2.5 border-t border-neutral-700 rounded-xl shadow-md shadow-neutral-800 group">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center gap-2.5 backdrop-blur-sm text-yellow-500 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500">
        <a
          href={liveLink}
          target="_black"
